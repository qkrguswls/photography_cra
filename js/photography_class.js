            ...
            $('.send-btn').on({
                click(e){
                    ...
                    $.ajax({
                        ...
                        url: 'https://qkrguswls309.com/photograpy_8/form_mail_ajax_insert.php', //form의 action부분, 서버파일 폼데이터를 받음
                        // 마이닷홈에서 유료전환-서비스변경-리눅스결제 ,,, 상세보기 - 무료SSL신청하기 - 서비스상품선택할때 유료도메인이 있어야함(리눅스결제 후에 해야함) ,,,, 신청 후에는 하루이틀 기다려야함 ,,,, 도메인 - 도메인검색 - 도메인신청하기
                        // http://로 live server해줘도 데이터가 DB에 올라가는 이유는 : php파일에 cors헤더코딩을 했기때문
                        type: 'POST',
